...
function _a6e(_a6f,a){
var item=$.easyui.getArrayItem(a,opts.valueField,_a6f);
return item?item[opts.textField]:undefined;
};
};
function _a70(_a71,data,_a72){
var _a73=$.data(_a71,"combobox");
var opts=_a73.options;
_a73.data=opts.loadFilter.call(_a71,data);
opts.view.render.call(opts.view,_a71,$(_a71).combo("panel"),_a73.data);
var vv=$(_a71).combobox("getValues");
$.easyui.forEach(_a73.data,false,function(row){
if(row["selected"]){
...
_a62(_a71,vv.length?[vv[vv.length-1]]:[],_a72);
}
opts.onLoadSuccess.call(_a71,data);
};
function _a74(_a75,url,_a76,_a77){
var opts=$.data(_a75,"combobox").options;
if(url){
opts.url=url;
}
_a76=$.extend({},opts.queryParams,_a76||{});
if(opts.onBeforeLoad.call(_a75,_a76)==false){
return;
}
opts.loader.call(_a75,_a76,function(data){
_a70(_a75,data,_a77);
},function(){
...
if(opts.mode=="remote"){
_a7c(qq);
_a74(_a79,null,{q:q},true);
}else{
var _a7d=$(_a79).combo("panel");
_a7d.find(".combobox-item-hover").removeClass("combobox-item-hover");
_a7d.find(".combobox-item,.combobox-group").hide();
var data=_a7a.data;
var vv=[];
$.map(qq,function(q){
q=$.trim(q);
...
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_a79,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
var item=opts.finder.getEl(_a79,v).show();
...
if(opts.groupField&&_a7f!=g){
opts.finder.getGroupEl(_a79,g).show();
_a7f=g;
}
}
}
...
function _a7c(vv){
if(opts.reversed){
_a7b.addClass("combobox-item-hover");
}else{
_a62(_a79,opts.multiple?(q?vv:[]):vv,true);
}
};
};
function _a80(_a81){
...
var _a82=t.combobox("panel");
var item=_a82.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_a81,item);
var _a83=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_a83);
}else{
t.combobox("select",_a83);
}
}else{
t.combobox("select",_a83);
}
...
function _a84(_a85){
var _a86=$.data(_a85,"combobox");
var opts=_a86.options;
$(_a85).addClass("combobox-f");
$(_a85).combo($.extend({},opts,{onShowPanel:function(){
$(this).combo("panel").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
_a62(this,$(this).combobox("getValues"),true);
$(this).combobox("scrollTo",$(this).combobox("getValue"));
opts.onShowPanel.call(this);
}}));
var p=$(_a85).combo("panel");
p.unbind(".combobox");
for(var _a87 in opts.panelEvents){
p.bind(_a87+".combobox",{target:_a85},opts.panelEvents[_a87]);
}
};
function _a88(e){
...
$(_a8b).combobox("setValue",_a8c).combobox("hidePanel");
}
e.stopPropagation();
};
function _a8d(e){
var _a8e=$(this).panel("options").comboTarget;
if(!_a8e){
return;
}
var opts=$(_a8e).combobox("options");
if(opts.groupPosition=="sticky"){
var _a8f=$(this).children(".combobox-stick");
if(!_a8f.length){
_a8f=$("<div class=\"combobox-stick\"></div>").appendTo(this);
}
_a8f.hide();
var _a90=$(_a8e).data("combobox");
$(this).children(".combobox-group:visible").each(function(){
var g=$(this);
var _a91=opts.finder.getGroup(_a8e,g);
var _a92=_a90.data[_a91.startIndex+_a91.count-1];
var last=opts.finder.getEl(_a8e,_a92[opts.valueField]);
if(g.position().top<0&&last.position().top>0){
_a8f.show().html(g.html());
return false;
}
});
}
};
$.fn.combobox=function(_a93,_a94){
if(typeof _a93=="string"){
var _a95=$.fn.combobox.methods[_a93];
if(_a95){
return _a95(this,_a94);
}else{
return this.combo(_a93,_a94);
}
}
_a93=_a93||{};
return this.each(function(){
var _a96=$.data(this,"combobox");
if(_a96){
$.extend(_a96.options,_a93);
}else{
_a96=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_a93),data:[]});
}
_a84(this);
if(_a96.options.data){
_a70(this,_a96.options.data);
}else{
...
var _a97=jq.combo("options");
return $.extend($.data(jq[0],"combobox").options,{width:_a97.width,height:_a97.height,originalValue:_a97.originalValue,disabled:_a97.disabled,readonly:_a97.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},setValues:function(jq,_a98){
return jq.each(function(){
var opts=$(this).combobox("options");
if($.isArray(_a98)){
_a98=$.map(_a98,function(_a99){
if(_a99&&typeof _a99=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.valueField,_a99);
return _a99[opts.valueField];
}else{
return _a99;
}
});
...
},setValue:function(jq,_a9a){
return jq.each(function(){
$(this).combobox("setValues",$.isArray(_a9a)?_a9a:[_a9a]);
});
},clear:function(jq){
return jq.each(function(){
_a62(this,[]);
...
},select:function(jq,_a9b){
return jq.each(function(){
_a5d(this,_a9b);
});
},unselect:function(jq,_a9c){
return jq.each(function(){
_a63(this,_a9c);
});
},scrollTo:function(jq,_a9d){
return jq.each(function(){
_a55(this,_a9d);
});
}};
$.fn.combobox.parseOptions=function(_a9e){
var t=$(_a9e);
return $.extend({},$.fn.combo.parseOptions(_a9e),$.parser.parseOptions(_a9e,["valueField","textField","groupField","groupPosition","mode","method","url",{showItemIcon:"boolean",limitToList:"boolean"}]));
};
$.fn.combobox.parseData=function(_a9f){
var data=[];
var opts=$(_a9f).combobox("options");
$(_a9f).children().each(function(){
if(this.tagName.toLowerCase()=="optgroup"){
var _aa0=$(this).attr("label");
...
row[opts.groupField]=_aa2;
}
data.push(row);
};
};
var _aa3=0;
var _aa4={render:function(_aa5,_aa6,data){
var _aa7=$.data(_aa5,"combobox");
var opts=_aa7.options;
_aa3++;
_aa7.itemIdPrefix="_easyui_combobox_i"+_aa3;
_aa7.groupIdPrefix="_easyui_combobox_g"+_aa3;
_aa7.groups=[];
var dd=[];
var _aa8=undefined;
for(var i=0;i<data.length;i++){
...
if(_aa8!=g){
_aa8=g;
_aa7.groups.push({value:g,startIndex:i,count:1});
dd.push("<div id=\""+(_aa7.groupIdPrefix+"_"+(_aa7.groups.length-1))+"\" class=\"combobox-group\">");
dd.push(opts.groupFormatter?opts.groupFormatter.call(_aa5,g):g);
dd.push("</div>");
}else{
_aa7.groups[_aa7.groups.length-1].count++;
}
}else{
_aa8=undefined;
}
var cls="combobox-item"+(row.disabled?" combobox-item-disabled":"")+(g?" combobox-gitem":"");
dd.push("<div id=\""+(_aa7.itemIdPrefix+"_"+i)+"\" class=\""+cls+"\">");
if(opts.showItemIcon&&row.iconCls){
dd.push("<span class=\"combobox-icon "+row.iconCls+"\"></span>");
}
dd.push(opts.formatter?opts.formatter.call(_aa5,row):s);
dd.push("</div>");
}
$(_aa6).html(dd.join(""));
}};
$.fn.combobox.defaults=$.extend({},$.fn.combo.defaults,{valueField:"value",textField:"text",groupPosition:"static",groupField:null,groupFormatter:function(_aa9){
return _aa9;
},mode:"local",method:"post",url:null,data:null,queryParams:{},showItemIcon:false,limitToList:false,unselectedValues:[],mappingRows:[],view:_aa4,keyHandler:{up:function(e){
nav(this,"prev");
e.preventDefault();
},down:function(e){
nav(this,"next");
...
var _aaa=e.data.target;
var opts=$(_aaa).combobox("options");
if(opts.reversed||opts.limitToList){
if(opts.blurTimer){
clearTimeout(opts.blurTimer);
}
opts.blurTimer=setTimeout(function(){
var _aab=$(_aaa).parent().length;
if(_aab){
if(opts.reversed){
$(_aaa).combobox("setValues",$(_aaa).combobox("getValues"));
}else{
if(opts.limitToList){
var vv=[];
$.map($(_aaa).combobox("getValues"),function(v){
var _aac=$.easyui.indexOfArray($(_aaa).combobox("getData"),opts.valueField,v);
if(_aac>=0){
vv.push(v);
}
});
$(_aaa).combobox("setValues",vv);
}
}
opts.blurTimer=null;
}
...
}}),panelEvents:{mouseover:_a88,mouseout:_a89,click:_a8a,scroll:_a8d},filter:function(q,row){
var opts=$(this).combobox("options");
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())>=0;
},formatter:function(row){
var opts=$(this).combobox("options");
return row[opts.textField];
},loader:function(_aad,_aae,_aaf){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
$.ajax({type:opts.method,url:opts.url,data:_aad,dataType:"json",success:function(data){
_aae(data);
},error:function(){
_aaf.apply(this,arguments);
}});
},loadFilter:function(data){
return data;
},finder:{getEl:function(_ab0,_ab1){
var _ab2=_a51(_ab0,_ab1);
var id=$.data(_ab0,"combobox").itemIdPrefix+"_"+_ab2;
return $("#"+id);
},getGroupEl:function(_ab3,_ab4){
var _ab5=$.data(_ab3,"combobox");
var _ab6=$.easyui.indexOfArray(_ab5.groups,"value",_ab4);
var id=_ab5.groupIdPrefix+"_"+_ab6;
return $("#"+id);
},getGroup:function(_ab7,p){
var _ab8=$.data(_ab7,"combobox");
var _ab9=p.attr("id").substr(_ab8.groupIdPrefix.length+1);
return _ab8.groups[parseInt(_ab9)];
},getRow:function(_aba,p){
var _abb=$.data(_aba,"combobox");
var _abc=(p instanceof $)?p.attr("id").substr(_abb.itemIdPrefix.length+1):_a51(_aba,p);
return _abb.data[parseInt(_abc)];
}},onBeforeLoad:function(_abd){
},onLoadSuccess:function(data){
},onLoadError:function(){
},onSelect:function(_abe){
},onUnselect:function(_abf){
},onClick:function(_ac0){
}});
})(jQuery);
(function($){
function _ac1(_ac2){
var _ac3=$.data(_ac2,"combotree");
var opts=_ac3.options;
var tree=_ac3.tree;
$(_ac2).addClass("combotree-f");
...
var _ac4=$(_ac2).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_ac4);
_ac3.tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _ac5=$(_ac2).combotree("getValues");
if(opts.multiple){
$.map(tree.tree("getChecked"),function(node){
$.easyui.addArrayItem(_ac5,node.id);
});
}
_aca(_ac2,_ac5,_ac3.remainText);
...
_ac3.remainText=false;
_ac7(_ac2);
opts.onClick.call(this,node);
},onCheck:function(node,_ac6){
_ac3.remainText=false;
_ac7(_ac2);
opts.onCheck.call(this,node,_ac6);
}}));
};
function _ac7(_ac8){
...
_aca(_ac8,vv,_ac9.remainText);
};
function _aca(_acb,_acc,_acd){
var _ace=$.data(_acb,"combotree");
var opts=_ace.options;
var tree=_ace.tree;
var _acf=tree.tree("options");
var _ad0=_acf.onBeforeCheck;
var _ad1=_acf.onCheck;
var _ad2=_acf.onSelect;
_acf.onBeforeCheck=_acf.onCheck=_acf.onSelect=function(){
};
if(!$.isArray(_acc)){
_acc=_acc.split(opts.separator);
}
if(!opts.multiple){
_acc=_acc.length?[_acc[0]]:[""];
}
var vv=$.map(_acc,function(_ad3){
return String(_ad3);
});
...
ss.push(_ad5(v,opts.mappingRows)||v);
...
_acf.onBeforeCheck=_ad0;
_acf.onCheck=_ad1;
_acf.onSelect=_ad2;
if(!_acd){
var s=ss.join(opts.separator);
if($(_acb).combo("getText")!=s){
$(_acb).combo("setText",s);
}
}
$(_acb).combo("setValues",vv);
function _ad5(_ad6,a){
var item=$.easyui.getArrayItem(a,"id",_ad6);
return item?_ad4(item):undefined;
};
function _ad4(node){
return node[opts.textField||""]||node.text;
};
};
function _ad7(_ad8,q){
var _ad9=$.data(_ad8,"combotree");
var opts=_ad9.options;
var tree=_ad9.tree;
_ad9.remainText=true;
tree.tree("doFilter",opts.multiple?q.split(opts.separator):q);
};
function _ada(_adb){
var _adc=$.data(_adb,"combotree");
_adc.remainText=false;
$(_adb).combotree("setValues",$(_adb).combotree("getValues"));
$(_adb).combotree("hidePanel");
};
$.fn.combotree=function(_add,_ade){
if(typeof _add=="string"){
var _adf=$.fn.combotree.methods[_add];
if(_adf){
return _adf(this,_ade);
}else{
return this.combo(_add,_ade);
}
}
_add=_add||{};
return this.each(function(){
var _ae0=$.data(this,"combotree");
if(_ae0){
$.extend(_ae0.options,_add);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_add)});
}
_ac1(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _ae1=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_ae1.width,height:_ae1.height,originalValue:_ae1.originalValue,disabled:_ae1.disabled,readonly:_ae1.readonly});
},clone:function(jq,_ae2){
var t=jq.combo("clone",_ae2);
...
},setValues:function(jq,_ae3){
return jq.each(function(){
var opts=$(this).combotree("options");
if($.isArray(_ae3)){
_ae3=$.map(_ae3,function(_ae4){
if(_ae4&&typeof _ae4=="object"){
$.easyui.addArrayItem(opts.mappingRows,"id",_ae4);
return _ae4.id;
}else{
return _ae4;
}
...
return jq.each(function(){
$(this).combotree("setValues",$.isArray(_ae5)?_ae5:[_ae5]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotree.parseOptions=function(_ae6){
return $.extend({},$.fn.combo.parseOptions(_ae6),$.fn.tree.parseOptions(_ae6));
};
...
var grid=_ae9.grid;
$(_ae8).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
_afe(this,$(this).combogrid("getValues"),true);
var p=$(this).combogrid("panel");
var _aea=p.outerHeight()-p.height();
var _aeb=p._size("minHeight");
var _aec=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_aeb?_aeb-_aea:""),maxHeight:(_aec?_aec-_aea:"")});
...
var _aed=$(_ae8).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_aed);
_ae9.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_aee,onClickRow:_aef,onSelect:_af0("onSelect"),onUnselect:_af0("onUnselect"),onSelectAll:_af0("onSelectAll"),onUnselectAll:_af0("onUnselectAll")}));
function _af1(dg){
return $(dg).closest(".combo-panel").panel("options").comboTarget||_ae8;
};
function _aee(data){
var _af2=_af1(this);
var _af3=$(_af2).data("combogrid");
var opts=_af3.options;
var _af4=$(_af2).combo("getValues");
_afe(_af2,_af4,_af3.remainText);
opts.onLoadSuccess.call(this,data);
};
function _aef(_af5,row){
var _af6=_af1(this);
var _af7=$(_af6).data("combogrid");
var opts=_af7.options;
_af7.remainText=false;
_af8.call(this);
if(!opts.multiple){
$(_af6).combo("hidePanel");
}
opts.onClickRow.call(this,_af5,row);
};
function _af0(_af9){
return function(_afa,row){
var _afb=_af1(this);
var opts=$(_afb).combogrid("options");
if(_af9=="onUnselectAll"){
if(opts.multiple){
_af8.call(this);
}
}else{
...
opts[_af9].call(this,_afa,row);
};
};
function _af8(){
var dg=$(this);
var _afc=_af1(dg);
var _afd=$(_afc).data("combogrid");
var opts=_afd.options;
var vv=$.map(dg.datagrid("getSelections"),function(row){
return row[opts.idField];
});
vv=vv.concat(opts.unselectedValues);
_afe(_afc,vv,_afd.remainText);
};
};
function nav(_aff,dir){
var _b00=$.data(_aff,"combogrid");
var opts=_b00.options;
var grid=_b00.grid;
var _b01=grid.datagrid("getRows").length;
if(!_b01){
return;
}
...
grid.datagrid("highlightRow",_b02);
if(opts.selectOnNavigation){
_b00.remainText=false;
grid.datagrid("selectRow",_b02);
}
};
function _afe(_b03,_b04,_b05){
var _b06=$.data(_b03,"combogrid");
var opts=_b06.options;
var grid=_b06.grid;
var _b07=$(_b03).combo("getValues");
var _b08=$(_b03).combo("options");
var _b09=_b08.onChange;
_b08.onChange=function(){
};
var _b0a=grid.datagrid("options");
var _b0b=_b0a.onSelect;
var _b0c=_b0a.onUnselectAll;
_b0a.onSelect=_b0a.onUnselectAll=function(){
};
if(!$.isArray(_b04)){
_b04=_b04.split(opts.separator);
}
if(!opts.multiple){
_b04=_b04.length?[_b04[0]]:[""];
}
var vv=$.map(_b04,function(_b0d){
return String(_b0d);
});
vv=$.grep(vv,function(v,_b0e){
return _b0e===$.inArray(v,vv);
});
var _b0f=$.grep(grid.datagrid("getSelections"),function(row,_b10){
return $.inArray(String(row[opts.idField]),vv)>=0;
});
grid.datagrid("clearSelections");
grid.data("datagrid").selectedRows=_b0f;
var ss=[];
opts.unselectedValues=[];
$.map(vv,function(v){
var _b11=grid.datagrid("getRowIndex",v);
if(_b11>=0){
grid.datagrid("selectRow",_b11);
}else{
opts.unselectedValues.push(v);
}
ss.push(_b12(v,grid.datagrid("getRows"))||_b12(v,_b0f)||_b12(v,opts.mappingRows)||v);
});
$(_b03).combo("setValues",_b07);
_b08.onChange=_b09;
_b0a.onSelect=_b0b;
_b0a.onUnselectAll=_b0c;
if(!_b05){
var s=ss.join(opts.separator);
if($(_b03).combo("getText")!=s){
$(_b03).combo("setText",s);
}
}
$(_b03).combo("setValues",_b04);
function _b12(_b13,a){
var item=$.easyui.getArrayItem(a,opts.idField,_b13);
return item?item[opts.textField]:undefined;
};
};
function _b14(_b15,q){
var _b16=$.data(_b15,"combogrid");
var opts=_b16.options;
var grid=_b16.grid;
_b16.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
...
q=$.trim(q);
var _b18=q;
_b19(opts.mappingRows,q);
_b19(grid.datagrid("getSelections"),q);
var _b1a=_b19(rows,q);
if(_b1a>=0){
if(opts.reversed){
grid.datagrid("highlightRow",_b1a);
}
}else{
$.map(rows,function(row,i){
if(opts.filter.call(_b15,q,row)){
...
function _b1b(_b1c){
var _b1d=$.data(_b1c,"combogrid");
var opts=_b1d.options;
var grid=_b1d.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_b1d.remainText=false;
if(tr.length){
var _b1e=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_b1e);
}else{
...
$(_b1c).combogrid("setValues",vv);
if(!opts.multiple){
$(_b1c).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_b1f,_b20){
if(typeof _b1f=="string"){
var _b21=$.fn.combogrid.methods[_b1f];
if(_b21){
...
_b1f=_b1f||{};
return this.each(function(){
var _b22=$.data(this,"combogrid");
if(_b22){
$.extend(_b22.options,_b1f);
}else{
_b22=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_b1f)});
}
_ae7(this);
});
};
...
return $.extend($.data(jq[0],"combogrid").options,{width:_b23.width,height:_b23.height,originalValue:_b23.originalValue,disabled:_b23.disabled,readonly:_b23.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
return jq.each(function(){
$(this).combogrid("setValues",$.isArray(_b26)?_b26:[_b26]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combogrid.parseOptions=function(_b27){
var t=$(_b27);
return $.extend({},$.fn.combo.parseOptions(_b27),$.fn.datagrid.parseOptions(_b27),$.parser.parseOptions(_b27,["idField","textField","mode"]));
};
...
var opts=$(_b28).combogrid("options");
if(opts.reversed){
$(_b28).combogrid("setValues",$(_b28).combogrid("getValues"));
}
...
(function($){
function _b29(_b2a){
var _b2b=$.data(_b2a,"combotreegrid");
var opts=_b2b.options;
$(_b2a).addClass("combotreegrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combotreegrid("panel");
var _b2c=p.outerHeight()-p.height();
var _b2d=p._size("minHeight");
var _b2e=p._size("maxHeight");
var dg=$(this).combotreegrid("grid");
dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_b2d?_b2d-_b2c:""),maxHeight:(_b2e?_b2e-_b2c:"")});
...
if(!_b2b.grid){
var _b2f=$(_b2a).combo("panel");
_b2b.grid=$("<table></table>").appendTo(_b2f);
}
_b2b.grid.treegrid($.extend({},opts,{border:false,checkbox:opts.multiple,onLoadSuccess:function(row,data){
var _b30=$(_b2a).combotreegrid("getValues");
if(opts.multiple){
$.map($(this).treegrid("getCheckedNodes"),function(row){
$.easyui.addArrayItem(_b30,row[opts.idField]);
});
}
_b35(_b2a,_b30);
opts.onLoadSuccess.call(this,row,data);
_b2b.remainText=false;
},onClickRow:function(row){
if(opts.multiple){
$(this).treegrid(row.checked?"uncheckNode":"checkNode",row[opts.idField]);
$(this).treegrid("unselect",row[opts.idField]);
}else{
$(_b2a).combo("hidePanel");
}
_b32(_b2a);
opts.onClickRow.call(this,row);
},onCheckNode:function(row,_b31){
_b32(_b2a);
opts.onCheckNode.call(this,row,_b31);
}}));
};
function _b32(_b33){
...
var _b38=$.data(_b36,"combotreegrid");
var opts=_b38.options;
var grid=_b38.grid;
if(!$.isArray(_b37)){
_b37=_b37.split(opts.separator);
}
if(!opts.multiple){
_b37=_b37.length?[_b37[0]]:[""];
}
var vv=$.map(_b37,function(_b39){
return String(_b39);
});
vv=$.grep(vv,function(v,_b3a){
return _b3a===$.inArray(v,vv);
});
var _b3b=grid.treegrid("getSelected");
if(_b3b){
grid.treegrid("unselect",_b3b[opts.idField]);
}
...
ss.push(_b3d(v,opts.mappingRows)||v);
opts.unselectedValues.push(v);
}
});
if(opts.multiple){
...
if(!_b38.remainText){
var s=ss.join(opts.separator);
if($(_b36).combo("getText")!=s){
$(_b36).combo("setText",s);
}
}
$(_b36).combo("setValues",vv);
function _b3d(_b3e,a){
var item=$.easyui.getArrayItem(a,opts.idField,_b3e);
return item?_b3c(item):undefined;
};
function _b3c(row){
return row[opts.textField||""]||row[opts.treeField];
};
};
function _b3f(_b40,q){
var _b41=$.data(_b40,"combotreegrid");
var opts=_b41.options;
var grid=_b41.grid;
_b41.remainText=true;
var qq=opts.multiple?q.split(opts.separator):[q];
qq=$.grep(qq,function(q){
return $.trim(q)!="";
});
...
if(opts.filter.call(_b40,q,row)){
...
_b42(vv);
_b41.remainText=false;
}
}
function _b42(vv){
if(!opts.reversed){
$(_b40).combotreegrid("setValues",vv);
}
};
};
function _b43(_b44){
...
if(!opts.multiple){
$(_b44).combotreegrid("hidePanel");
}
};
$.fn.combotreegrid=function(_b46,_b47){
if(typeof _b46=="string"){
var _b48=$.fn.combotreegrid.methods[_b46];
if(_b48){
return _b48(this,_b47);
}else{
return this.combo(_b46,_b47);
}
}
_b46=_b46||{};
return this.each(function(){
var _b49=$.data(this,"combotreegrid");
if(_b49){
$.extend(_b49.options,_b46);
}else{
_b49=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_b46)});
}
_b29(this);
});
};
$.fn.combotreegrid.methods={options:function(jq){
var _b4a=jq.combo("options");
return $.extend($.data(jq[0],"combotreegrid").options,{width:_b4a.width,height:_b4a.height,originalValue:_b4a.originalValue,disabled:_b4a.disabled,readonly:_b4a.readonly});
},grid:function(jq){
return $.data(jq[0],"combotreegrid").grid;
},setValues:function(jq,_b4b){
return jq.each(function(){
var opts=$(this).combotreegrid("options");
if($.isArray(_b4b)){
_b4b=$.map(_b4b,function(_b4c){
if(_b4c&&typeof _b4c=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_b4c);
return _b4c[opts.idField];
}else{
return _b4c;
}
});
...
},setValue:function(jq,_b4d){
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_b4d)?_b4d:[_b4d]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_b4e){
var t=$(_b4e);
return $.extend({},$.fn.combo.parseOptions(_b4e),$.fn.treegrid.parseOptions(_b4e),$.parser.parseOptions(_b4e,["mode",{limitToGrid:"boolean"}]));
};
...
var opts=$(_b4f).combotreegrid("options");
if(opts.limitToGrid){
_b43(_b4f);
}
}}),filter:function(q,row){
...
$(_b51).addClass("tagbox-f").combobox($.extend({},opts,{cls:"tagbox",reversed:true,onChange:function(_b53,_b54){
_b55();
$(this).combobox("hidePanel");
opts.onChange.call(_b51,_b53,_b54);
},onResizing:function(_b56,_b57){
var _b58=$(this).combobox("textbox");
var tb=$(this).data("textbox").textbox;
tb.css({height:"",paddingLeft:_b58.css("marginLeft"),paddingRight:_b58.css("marginRight")});
_b58.css("margin",0);
tb._size({width:opts.width},$(this).parent());
_b6b(_b51);
_b5d(this);
opts.onResizing.call(_b51,_b56,_b57);
},onLoadSuccess:function(data){
_b55();
opts.onLoadSuccess.call(_b51,data);
}}));
_b55();
_b6b(_b51);
function _b55(){
$(_b51).next().find(".tagbox-label").remove();
var _b59=$(_b51).tagbox("textbox");
var ss=[];
$.map($(_b51).tagbox("getValues"),function(_b5a,_b5b){
var row=opts.finder.getRow(_b51,_b5a);
var text=opts.tagFormatter.call(_b51,_b5a,row);
var cs={};
var css=opts.tagStyler.call(_b51,_b5a,row)||"";
if(typeof css=="string"){
cs={s:css};
}else{
cs={c:css["class"]||"",s:css["style"]||""};
}
var _b5c=$("<span class=\"tagbox-label\"></span>").insertBefore(_b59).html(text);
_b5c.attr("tagbox-index",_b5b);
_b5c.attr("style",cs.s).addClass(cs.c);
$("<a href=\"javascript:;\" class=\"tagbox-remove\"></a>").appendTo(_b5c);
});
_b5d(_b51);
$(_b51).combobox("setText","");
};
};
function _b5d(_b5e,_b5f){
var span=$(_b5e).next();
var _b60=_b5f?$(_b5f):span.find(".tagbox-label");
if(_b60.length){
var _b61=$(_b5e).tagbox("textbox");
var _b62=$(_b60[0]);
var _b63=_b62.outerHeight(true)-_b62.outerHeight();
var _b64=_b61.outerHeight()-_b63*2;
_b60.css({height:_b64+"px",lineHeight:_b64+"px"});
var _b65=span.find(".textbox-addon").css("height","100%");
_b65.find(".textbox-icon").css("height","100%");
...
var _b68=parseInt($(e.target).parent().attr("tagbox-index"));
var _b69=$(_b67).tagbox("getValues");
if(opts.onBeforeRemoveTag.call(_b67,_b69[_b68])==false){
return;
}
opts.onRemoveTag.call(_b67,_b69[_b68]);
_b69.splice(_b68,1);
$(_b67).tagbox("setValues",_b69);
}else{
var _b6a=$(e.target).closest(".tagbox-label");
if(_b6a.length){
var _b68=parseInt(_b6a.attr("tagbox-index"));
var _b69=$(_b67).tagbox("getValues");
opts.onClickTag.call(_b67,_b69[_b68]);
}
}
...
function _b6b(_b6c){
var opts=$(_b6c).tagbox("options");
var _b6d=$(_b6c).tagbox("textbox");
var span=$(_b6c).next();
var tmp=$("<span></span>").appendTo("body");
tmp.attr("style",_b6d.attr("style"));
tmp.css({position:"absolute",top:-9999,left:-9999,width:"auto",fontFamily:_b6d.css("fontFamily"),fontSize:_b6d.css("fontSize"),fontWeight:_b6d.css("fontWeight"),whiteSpace:"nowrap"});
var _b6e=_b6f(_b6d.val());
var _b70=_b6f(opts.prompt||"");
tmp.remove();
var _b71=Math.min(Math.max(_b6e,_b70)+20,span.width());
_b6d._outerWidth(_b71);
span.find(".textbox-button").linkbutton("resize",{height:"100%"});
function _b6f(val){
...
if(opts.limitToList){
var _b74=t.tagbox("panel");
var item=_b74.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_b73,item);
var _b75=row[opts.valueField];
$(_b73).tagbox(item.hasClass("combobox-item-selected")?"unselect":"select",_b75);
}
$(_b73).tagbox("hidePanel");
}else{
var v=$.trim($(_b73).tagbox("getText"));
if(v!==""){
var _b76=$(_b73).tagbox("getValues");
_b76.push(v);
$(_b73).tagbox("setValues",_b76);
}
}
};
function _b77(_b78,_b79){
$(_b78).combobox("setText","");
_b6b(_b78);
$(_b78).combobox("setValues",_b79);
$(_b78).combobox("setText","");
$(_b78).tagbox("validate");
};
$.fn.tagbox=function(_b7a,_b7b){
if(typeof _b7a=="string"){
var _b7c=$.fn.tagbox.methods[_b7a];
if(_b7c){
return _b7c(this,_b7b);
}else{
return this.combobox(_b7a,_b7b);
}
}
_b7a=_b7a||{};
return this.each(function(){
var _b7d=$.data(this,"tagbox");
if(_b7d){
$.extend(_b7d.options,_b7a);
}else{
$.data(this,"tagbox",{options:$.extend({},$.fn.tagbox.defaults,$.fn.tagbox.parseOptions(this),_b7a)});
}
_b50(this);
_b66(this);
});
...
var _b7e=jq.combobox("options");
return $.extend($.data(jq[0],"tagbox").options,{width:_b7e.width,height:_b7e.height,originalValue:_b7e.originalValue,disabled:_b7e.disabled,readonly:_b7e.readonly});
},setValues:function(jq,_b7f){
return jq.each(function(){
_b77(this,_b7f);
});
},reset:function(jq){
...
$.fn.tagbox.parseOptions=function(_b80){
return $.extend({},$.fn.combobox.parseOptions(_b80),$.parser.parseOptions(_b80,[]));
};
$.fn.tagbox.defaults=$.extend({},$.fn.combobox.defaults,{hasDownArrow:false,multiple:true,reversed:true,selectOnNavigation:false,tipOptions:$.extend({},$.fn.textbox.defaults.tipOptions,{showDelay:200}),val:function(_b81){
var vv=$(_b81).parent().prev().tagbox("getValues");
if($(_b81).is(":focus")){
vv.push($(_b81).val());
}
return vv.join(",");
},inputEvents:$.extend({},$.fn.combo.defaults.inputEvents,{blur:function(e){
var _b82=e.data.target;
var opts=$(_b82).tagbox("options");
if(opts.limitToList){
_b72(_b82);
}
...
}}),tagFormatter:function(_b83,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_b83;
},tagStyler:function(_b84,row){
return "";
},onClickTag:function(_b85){
},onBeforeRemoveTag:function(_b86){
},onRemoveTag:function(_b87){
}});
})(jQuery);
(function($){
function _b88(_b89){
var _b8a=$.data(_b89,"datebox");
var opts=_b8a.options;
$(_b89).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_b8b(this);
_b8c(this);
_b8d(this);
_b9b(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_b8a.calendar){
var _b8e=$(_b89).combo("panel").css("overflow","hidden");
_b8e.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_b8e);
...
_b8a.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_b8a.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _b8f=this.target;
var opts=$(_b8f).datebox("options");
_b9b(_b8f,opts.formatter.call(_b8f,date));
$(_b8f).combo("hidePanel");
opts.onSelect.call(_b8f,date);
}});
}
$(_b89).combo("textbox").parent().addClass("datebox");
$(_b89).datebox("initValue",opts.value);
function _b8b(_b90){
var opts=$(_b90).datebox("options");
var _b91=$(_b90).combo("panel");
_b91.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _b92=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_b92].handler.call(e.target,_b90);
}
});
};
function _b8c(_b93){
var _b94=$(_b93).combo("panel");
if(_b94.children("div.datebox-button").length){
return;
}
var _b95=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_b94);
var tr=_b95.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_b93):btn.text).appendTo(td);
t.attr("datebox-button-index",i);
}
tr.find("td").css("width",(100/opts.buttons.length)+"%");
};
function _b8d(_b96){
var _b97=$(_b96).combo("panel");
var cc=_b97.children("div.datebox-calendar-inner");
_b97.children()._outerWidth(_b97.width());
_b8a.calendar.appendTo(cc);
_b8a.calendar[0].target=_b96;
if(opts.panelHeight!="auto"){
var _b98=_b97.height();
_b97.children().not(cc).each(function(){
_b98-=$(this).outerHeight();
});
cc._outerHeight(_b98);
}
_b8a.calendar.calendar("resize");
};
};
...
function _b9c(_b9d){
var _b9e=$.data(_b9d,"datebox");
var opts=_b9e.options;
var _b9f=_b9e.calendar.calendar("options").current;
if(_b9f){
_b9b(_b9d,opts.formatter.call(_b9d,_b9f));
$(_b9d).combo("hidePanel");
}
};
function _b9b(_ba0,_ba1,_ba2){
var _ba3=$.data(_ba0,"datebox");
var opts=_ba3.options;
var _ba4=_ba3.calendar;
_ba4.calendar("moveTo",opts.parser.call(_ba0,_ba1));
if(_ba2){
$(_ba0).combo("setValue",_ba1);
}else{
if(_ba1){
_ba1=opts.formatter.call(_ba0,_ba4.calendar("options").current);
}
$(_ba0).combo("setText",_ba1).combo("setValue",_ba1);
}
};
$.fn.datebox=function(_ba5,_ba6){
if(typeof _ba5=="string"){
var _ba7=$.fn.datebox.methods[_ba5];
if(_ba7){
return _ba7(this,_ba6);
}else{
return this.combo(_ba5,_ba6);
}
}
_ba5=_ba5||{};
return this.each(function(){
var _ba8=$.data(this,"datebox");
if(_ba8){
$.extend(_ba8.options,_ba5);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_ba5)});
}
_b88(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _ba9=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{width:_ba9.width,height:_ba9.height,originalValue:_ba9.originalValue,disabled:_ba9.disabled,readonly:_ba9.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
$.fn.datebox.parseOptions=function(_bad){
return $.extend({},$.fn.combo.parseOptions(_bad),$.parser.parseOptions(_bad,["sharedCalendar"]));
};
...
_b99(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_bae){
return $(_bae).datebox("options").currentText;
},handler:function(_baf){
var now=new Date();
$(_baf).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_b9c(_baf);
}},{text:function(_bb0){
return $(_bb0).datebox("options").closeText;
...
(function($){
function _bb2(_bb3){
var _bb4=$.data(_bb3,"datetimebox");
var opts=_bb4.options;
$(_bb3).datebox($.extend({},opts,{onShowPanel:function(){
var _bb5=$(this).datetimebox("getValue");
_bbb(this,_bb5,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_bb3).removeClass("datebox-f").addClass("datetimebox-f");
$(_bb3).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_bb4.spinner){
var _bb6=$(_bb3).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_bb6.children("div.datebox-calendar-inner"));
_bb4.spinner=p.children("input");
}
_bb4.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_bb3).datetimebox("initValue",opts.value);
};
function _bb7(_bb8){
var c=$(_bb8).datetimebox("calendar");
var t=$(_bb8).datetimebox("spinner");
...
function _bbc(_bbd){
var opts=$.data(_bbd,"datetimebox").options;
var date=_bb7(_bbd);
_bbb(_bbd,opts.formatter.call(_bbd,date));
$(_bbd).combo("hidePanel");
};
function _bbb(_bbe,_bbf,_bc0){
var opts=$.data(_bbe,"datetimebox").options;
$(_bbe).combo("setValue",_bbf);
if(!_bc0){
if(_bbf){
var date=opts.parser.call(_bbe,_bbf);
$(_bbe).combo("setText",opts.formatter.call(_bbe,date));
$(_bbe).combo("setValue",opts.formatter.call(_bbe,date));
}else{
$(_bbe).combo("setText",_bbf);
}
}
var date=opts.parser.call(_bbe,_bbf);
$(_bbe).datetimebox("calendar").calendar("moveTo",date);
$(_bbe).datetimebox("spinner").timespinner("setValue",_bc1(date));
function _bc1(date){
function _bc2(_bc3){
return (_bc3<10?"0":"")+_bc3;
};
var tt=[_bc2(date.getHours()),_bc2(date.getMinutes())];
if(opts.showSeconds){
tt.push(_bc2(date.getSeconds()));
}
return tt.join($(_bbe).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_bc4,_bc5){
if(typeof _bc4=="string"){
var _bc6=$.fn.datetimebox.methods[_bc4];
if(_bc6){
return _bc6(this,_bc5);
}else{
return this.datebox(_bc4,_bc5);
}
}
_bc4=_bc4||{};
return this.each(function(){
var _bc7=$.data(this,"datetimebox");
if(_bc7){
$.extend(_bc7.options,_bc4);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_bc4)});
}
_bb2(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _bc8=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_bc8.originalValue,disabled:_bc8.disabled,readonly:_bc8.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_bc9){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _bca=opts.value;
if(_bca){
_bca=opts.formatter.call(this,opts.parser.call(this,_bca));
}
$(this).combo("initValue",_bca).combo("setText",_bca);
});
...
$.fn.datetimebox.parseOptions=function(_bcc){
var t=$(_bcc);
return $.extend({},$.fn.datebox.parseOptions(_bcc),$.parser.parseOptions(_bcc,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_bb9(this,q);
}},buttons:[{text:function(_bcd){
return $(_bcd).datetimebox("options").currentText;
},handler:function(_bce){
var opts=$(_bce).datetimebox("options");
_bbb(_bce,opts.formatter.call(_bce,new Date()));
$(_bce).datetimebox("hidePanel");
}},{text:function(_bcf){
return $(_bcf).datetimebox("options").okText;
},handler:function(_bd0){
_bbc(_bd0);
}},{text:function(_bd1){
return $(_bd1).datetimebox("options").closeText;
...
function _bd3(_bd4){
return (_bd4<10?"0":"")+_bd4;
};
var _bd5=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_bd3(h)+_bd5+_bd3(M);
...
var _bd6=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_bd6);
var hour=parseInt(tt[0],10)||0;
var _bd7=parseInt(tt[1],10)||0;
var _bd8=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_bd7,_bd8);
}});
})(jQuery);
(function($){
function init(_bd9){
var _bda=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_bd9);
var t=$(_bd9);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_bda.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_bda.bind("_resize",function(e,_bdb){
if($(this).hasClass("easyui-fluid")||_bdb){
_bdc(_bd9);
}
return false;
});
...
var _bdf=$.data(_bdd,"slider");
var opts=_bdf.options;
var _be0=_bdf.slider;
if(_bde){
if(_bde.width){
opts.width=_bde.width;
}
if(_bde.height){
opts.height=_bde.height;
}
}
_be0._size(opts);
if(opts.mode=="h"){
_be0.css("height","");
_be0.children("div").css("height","");
}else{
_be0.css("width","");
_be0.children("div").css("width","");
_be0.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_be0._outerHeight());
}
_be1(_bdd);
};
function _be2(_be3){
...
_be6(aa);
function _be6(aa){
var rule=_be5.find("div.slider-rule");
var _be7=_be5.find("div.slider-rulelabel");
rule.empty();
_be7.empty();
for(var i=0;i<aa.length;i++){
var _be8=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_be8);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_be7);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_be8,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_be8,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _be9(_bea){
var _beb=$.data(_bea,"slider");
var opts=_beb.options;
var _bec=_beb.slider;
_bec.removeClass("slider-h slider-v slider-disabled");
_bec.addClass(opts.mode=="h"?"slider-h":"slider-v");
_bec.addClass(opts.disabled?"slider-disabled":"");
var _bed=_bec.find(".slider-inner");
_bed.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_bed.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_bec.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_beb.isDragging=true;
opts.onSlideStart.call(_bea,opts.value);
},onStopDrag:function(e){
_bef(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_bea,opts.value);
opts.onComplete.call(_bea,opts.value);
_beb.isDragging=false;
}});
_bec.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_beb.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_bef(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_bea,opts.value);
});
function _bef(pos,_bf0){
var _bf1=_bf2(_bea,pos);
var s=Math.abs(_bf1%opts.step);
if(s<opts.step/2){
_bf1-=s;
}else{
_bf1=_bf1-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_bf0){
var _bf3=$(_bf0).nextAll(".slider-handle").length>0;
if(_bf1<=v2&&_bf3){
v1=_bf1;
}else{
if(_bf1>=v1&&(!_bf3)){
...
_bf1<m?v1=_bf1:v2=_bf1;
}
}
}
$(_bea).slider("setValues",[v1,v2]);
}else{
$(_bea).slider("setValue",_bf1);
}
};
};
function _bf4(_bf5,_bf6){
var _bf7=$.data(_bf5,"slider");
var opts=_bf7.options;
var _bf8=_bf7.slider;
var _bf9=$.isArray(opts.value)?opts.value:[opts.value];
var _bfa=[];
if(!$.isArray(_bf6)){
_bf6=$.map(String(_bf6).split(opts.separator),function(v){
return parseFloat(v);
});
}
_bf8.find(".slider-value").remove();
var name=$(_bf5).attr("sliderName")||"";
for(var i=0;i<_bf6.length;i++){
var _bfb=_bf6[i];
if(_bfb<opts.min){
_bfb=opts.min;
}
...
var _bfc=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_bf8);
_bfc.attr("name",name);
_bfc.val(_bfb);
_bfa.push(_bfb);
var _bfd=_bf8.find(".slider-handle:eq("+i+")");
var tip=_bfd.next();
var pos=_bfe(_bf5,_bfb);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_bf5,_bfb));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _bff="left:"+pos+"px;";
_bfd.attr("style",_bff);
tip.attr("style",_bff+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _bff="top:"+pos+"px;";
_bfd.attr("style",_bff);
tip.attr("style",_bff+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_bfa:_bfa[0];
$(_bf5).val(opts.range?_bfa.join(opts.separator):_bfa[0]);
if(_bf9.join(",")!=_bfa.join(",")){
opts.onChange.call(_bf5,opts.value,(opts.range?_bf9:_bf9[0]));
}
};
function _be1(_c00){
var opts=$.data(_c00,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_bf4(_c00,opts.value);
opts.onChange=fn;
};
function _bfe(_c01,_c02){
var _c03=$.data(_c01,"slider");
var opts=_c03.options;
var _c04=_c03.slider;
var size=opts.mode=="h"?_c04.width():_c04.height();
var pos=opts.converter.toPosition.call(_c01,_c02,size);
if(opts.mode=="v"){
pos=_c04.height()-pos;
}
if(opts.reversed){
...
function _bf2(_c05,pos){
var _c06=$.data(_c05,"slider");
var opts=_c06.options;
var _c07=_c06.slider;
var size=opts.mode=="h"?_c07.width():_c07.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _c08=opts.converter.toValue.call(_c05,pos,size);
return _c08.toFixed(0);
};
$.fn.slider=function(_c09,_c0a){
if(typeof _c09=="string"){
return $.fn.slider.methods[_c09](this,_c0a);
}
_c09=_c09||{};
return this.each(function(){
var _c0b=$.data(this,"slider");
if(_c0b){
$.extend(_c0b.options,_c09);
}else{
_c0b=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_c09),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_bf4(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_c0f){
var t=$(_c0f);
return $.extend({},$.parser.parseOptions(_c0f,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_c10){
return _c10;
},converter:{toPosition:function(_c11,size){
var opts=$(this).slider("options");
return (_c11-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_c12,_c13){
},onSlideStart:function(_c14){
},onSlideEnd:function(_c15){
},onComplete:function(_c16){
}};
})(jQuery);
